...
<html lang="en">
    <head>
        ...
        $list = array(
            ...
            array('rel' => 'stylesheet', 'type' => 'text/css', 'media' => 'screen', 'href' => 'asset/calendar/fullcalendar.css'),
            array('rel' => 'stylesheet', 'type' => 'text/css', 'media' => 'print', 'href' => 'asset/calendar/fullcalendar.print.css'),
        );
                ...
                <div class="wrapper">
                   ...
                   <nav id="nav">
                        <ul class="menu">
                            ...
                            <li><?= anchor("tentang", "Tentang JSM", array('title' => 'Tentang JSM', 'class' => 'active')) ?></li>
                        </ul>
                    </nav>
                </div>
