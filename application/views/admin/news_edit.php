        ...
        <div class="container_12">
            ...
            <div class="grid_12">
                <div class="block-border">
                    ...
                    echo form_open('berita/update', $attributes, $hidden);
                    ?>
                    <div class="_100">
                        <p><label for="textfield">Judul Berita</label>
                            <input name="string2" class="required" type="text" value="<?= $berita->judul_berita ?>" /></p>
                    </div>

                    <div class="_100">
                        <p><label for="textarea">Isi Berita</label>
                            <textarea id="textarea"  name="string3" class="required" rows="7" cols="40"><?= $berita->isi_berita ?></textarea></p>
                    </div>
                    <div class="_100">
