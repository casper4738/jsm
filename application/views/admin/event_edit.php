        ...
        <div class="container_12">
            ...
            <div class="grid_12">
                <div class="block-border">
                    ...
                    echo form_open('event/update', $attributes, $hidden);
                    ?>
                    <div class="_100">
                        <p><label for="textfield">Nama Event</label>
                            <input name="string2" class="required" type="text" value="<?= $event->judul_event ?>" /></p>
                    </div>
                    <div class="_50">
                        <p class="inline-small-label">
                            <span class="label">Tanggal Event</span>
                            <input id="datepicker" name="string4" class="required" type="text" value="<?= date("m/d/y", strtotime($event->tanggal_event)) ?>" />
                        </p>
                    </div>
                    <div class="_100">
                        <p><label for="textarea">Info Event</label>
                            <textarea id="textarea" name="string3" class="required" rows="7" cols="40"><?= $event->isi_event ?></textarea></p>
                    </div>
                    <div class="clear"></div>
