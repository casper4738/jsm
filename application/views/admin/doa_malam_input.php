                        ...
                        <center>
                            ...
                            <table border="1" cellpadding="5" >
                                <tr>
                                    ...
                                    <td style='text-align:center'  ><strong>PDB</strong></td>
                                ...
                                for ($index = 1; $index < 31; $index++) {
                                    ...
                                    $strx1 = $this->sel_model->get_list2("$tahun-$bulan-$index", "SYAFAAT_MALAM")->result()[0]->nama_sel;
                                    $strx2 = $this->sel_model->get_list2("$tahun-$bulan-$index", "PDB")->result()[0]->nama_sel;
                                    ...
                                    echo "<td style='vertical-align:middle; text-align:center' width='35'><input type='checkbox' name='pdb$index []'  value='PDB' " . functionCek2($strx2, "PDB") . "  /> </td>";
                                    echo "<td width='150'><input type='text' name='syafaat_malam$index []'  value='$strx1' /></td>";
                                    echo "</tr>";
                                }
                                ?>
                            </table>
