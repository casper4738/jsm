        ...
        <div class="container_12">
            ...
            <div class="grid_12">
                <div class="block-border">
                    ...
                    echo form_open('korbid/insert', $attributes, $hidden);
                    ?>
                    ...
                    <div class="_100">
                        <p><label for="textarea">Singer</label>
                            <textarea name="string4" class="required" rows="5" cols="40"></textarea></p>
                    </div>
                    <div class="_100">
                    ...
                    <div class="_100">
                        <p><label for="textarea">Atur Alat</label>
                            <textarea name="string6" class="required" rows="5" cols="40"></textarea></p>
                    </div>
