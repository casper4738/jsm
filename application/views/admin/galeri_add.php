        ...
        <div class="container_12">
            ...
            <div class="grid_12">
                <div class="block-border">
                    ...
                    <?php
                    $hidden = array('string1' => $id_galeri);
                    $attributes = array('class' => 'block-content form', 'id' => 'validate-form');
                    echo form_open_multipart('galeri/insert', $attributes, $hidden);
                    ?>
                    <div class="_75">
                        <p><label for="textfield">Judul Foto</label>
                            <input name="string2" class="required" type="text" value="<?= $judul_foto ?>" /></p>
                    </div>
                    <div class="_25">
                        <p>
                            <span class="label">Tanggal Foto</span>
                            <input id="datepicker" name="string3" class="required" type="text" value="<?= date("m/d/Y", strtotime($tanggal_foto)) ?>" />
                        </p>
                    </div>
                    <div class="_100">
                        <p>
                    ...
                    <div class="_100">
                        <p><label for="textarea">Info</label>
                            <textarea id="textarea" name="string5" rows="7" cols="40"></textarea></p>
                    </div>
