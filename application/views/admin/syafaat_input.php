        ...
        <div class="container_12">
            ...
            <div class="grid_12">
                <div class="block-border">
                    ...
                    echo form_open('sel/insert_pelayanan3', $attributes, $hidden);
                    ?>
                            ...
                            <table border="1" >
                                ...
                                for ($index = 1; $index < 31; $index++) {
                                    ...
                                    for ($i = 0; $i < count($sel); $i++) {
                                        echo "<tr>";
                                        $data_arrayx = array();
                                        foreach ($this->sel_model->get_list2("$tahun-$bulan-$index", "SYAFAAT")->result() as $value) {
                                            $data_arrayx[] = $value->nama_sel;
                                        }
                                        for ($j = 1; $j <= 6; $j++) {
                                            echo "<td width='35'><input type='checkbox' name='syafaat$index []'  value='$sel[$i]$j' " . functionCek($data_arrayx, "$sel[$i]$j") . "/> $sel[$i]$j</td>";
                                        }
                                        echo "</tr>";
                                    }
                                    echo "</table>";
